    ...
    <section class="section">
      ...
      <div class="row p-3">
        ...
        <div class="col-5">
          ...
          <p>
            <button class="btn btn-yellow" @click="openModel('Visor Lite')">Заказать</button>
          </p>
        </div>
      </div>
      ...
      <div class="row p-3">
        ...
        <div class="col-5">
          ...
          <p>
            <button class="btn btn-yellow" @click="openModel('Visor Pro Lite')">Заказать</button>
          </p>
        </div>
      </div>
    </section>

    <order-modal :selectedModel="selectedModel" title="Заказ защитного козырька" />
  </div>
</template>
