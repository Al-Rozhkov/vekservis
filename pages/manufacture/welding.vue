    ...
    <section class="container">
      ...
      <div class="p-3 list-img welding-imgs">
        <img
          v-for="item in 10"
          :key="item"
          :src="`/img/welding/small/${numPad(item)}.jpg`"
          v-img="{
            src: `/img/welding/${numPad(item)}.jpg`,
            group: 'welding',
      ...
      <section class="row">
        <div class="col-5">...</div>
        <div class="col-7">
          <p>Сварные детали нашли свое применение в&nbsp;огромном количестве изделий, механизмов и&nbsp;строений. Во&nbsp;многих случаях они подвергаются различным нагрузкам и&nbsp;поэтому должны быть прочными и&nbsp;надежными. При некачественном выполнении сварочных работ в месте шва возникают трещины, полости или даже участки неполного проплавления, что значительно снижает срок службы и прочность конструкции.</p>
          <p>Для расчета стоимости вашего заказа просим прикрепить имеющуюся документацию на&nbsp;изделия и&nbsp;сообщите нам, как с&nbsp;вами связаться.</p>
